...
router.get("/analytics", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), transaction_controller_1.TransactionControllers.getTransactionAnalytics);
...
router.get("/my-transactions/:transId", (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), transaction_controller_1.TransactionControllers.getMyTransactionById);
router.get("/single-transactions/:transId", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), transaction_controller_1.TransactionControllers.getSingleTransactionById);
